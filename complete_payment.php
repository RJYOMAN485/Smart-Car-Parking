...
if($otp=="123456")
{
	...
	$ticket=rand(10,100);
    $result=mysqli_query($connection,"insert into bookings values('$bookid','$ticket','".$_SESSION['amount']."','confirmed','".$_SESSION['user']."',curdate())");
	if($result){
		$_SESSION['success']="Booking Successfully Completed";
		mysqli_query($connection,"UPDATE park_status SET pid=0");
	}
	else {
